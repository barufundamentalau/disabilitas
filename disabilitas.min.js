...
@font-face {
  ...
  .content_aksesbilitas_utama {
    ...
    z-index: 999999999999;
    position: fixed;
    background-color: rgb(22, 179, 172);
    width: 500px;
    height: 100vh;
  ...
  .group_scroll_content::-webkit-scrollbar-track {
    ...
    box-shadow: inset 0 0 6px rgb(22, 179, 172);
    border-radius: 8px;
  ...
  .group_scroll_content::-webkit-scrollbar-thumb {
    ...
    -webkit-border-radius: 8px;
    border-radius: 8px;
    background: rgb(22, 179, 172); 
    -webkit-box-shadow: inset 0 0 6px rgb(22, 179, 172);
  ...
  .box_group_disabilitas:hover {
    ...
    width: 150px;
    height: 125px;
    border: 2px solid rgb(22, 179, 172);
    cursor: pointer;
    box-shadow: 0 0 5px rgba(0, 0, 0, 0.4);
  }
...
var my_website_jkt = ''
var except_url = ['www.ellnews.id', 'ellnews.id']
if (
...
-24 730 0 31 14 65 64 65 94 0 30 -34 80 -65 94 -49 24 -684 23 -732 0z" />
                    ...
                    Aksesibilitas - Powered by SIMRS
                </div>
                   ...
                   Di Buat Oleh : 
                    ...
                    <a href="http://rsud.kotamobagu.go.id" class="column_cek_creator" target="_blank">
                    Powered by SIMRS
                </a>
                </div-->
                </div>
  ...
  $('#action_moda_suara').click(function (event) {
    ...
    if ($('#action_moda_suara').hasClass('active_box_menu_disabilitas')) {
      ...
      if (getOS() == 'iOS' || getOS() == 'Android') {
        ...
        speachmobile(
          'Selamat Datang di Sistem Aman Simpel Terintegrasi, Si Asri RSUD Kotamobagu. Pendaftaran Khusus Pasien Prioritas, Skarang Tidak Perlu Antri Di Apotik, Obat Diantar Langsung Ke Rumah oleh Sahabat Pengantar Obat.'
        )
      } else {
        localStorage.setItem('permisvoice', 'on')
        speach(
          'Selamat Datang di Sistem Aman Simpel Terintegrasi, Si Asri RSUD Kotamobagu. Pendaftaran Khusus Pasien Prioritas, Sekarang Tidak Perlu Antri Di Apotik, Obat Diantar Langsung Ke Rumah oleh Sahabat Pengantar Obat.'
        )
      }
  ...
  $('#action_tulisan_dapat_di_baca').click(function (event) {
    ...
    if (
      $('#action_tulisan_dapat_di_baca').hasClass('active_box_menu_disabilitas')
    ) {
      action_text_besar.length = 0
